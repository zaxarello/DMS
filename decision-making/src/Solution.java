...
public class Solution {
    ...
    public static void second() {
        ...
        names.add("Вулканы");
        names.add("Атмосфера");
        importance.add("Температура");
        importance.add("Атмосфера");
        importance.add("Вода");
        importance.add("Вулканы");
        importance.add("Плотность");
        List<Alternative.Criteria> narrowing = new ArrayList<>();
        narrowing.add(new Alternative.Criteria("Температура", 100, true));
        narrowing.add(new Alternative.Criteria("Вода", 3, false));
        narrowing.add(new Alternative.Criteria("Атмосфера", 0, false));
        heights.add(false);
        heights.add(true);
        heights.add(true);
        heights.add(false);
